...
function print_clasificacion( $clasificacion )
{
	...
	<h1>Clasificacion</h1>
	<table BORDER="1">
	<tr><th>Equipo</th><th>Puntos</th><th>PL</th><th>PV</th><th>Goles</th><th>GL</th><th>GV</th></tr>
	...
	<td><?php echo $equipo['goles'] ?></td>
	<td><?php echo $equipo['golesLocal'] ?></td>
	<td><?php echo $equipo['golesVisitante'] ?></td>
	</tr>
	<?php } ?>
	</table>
	<br>
